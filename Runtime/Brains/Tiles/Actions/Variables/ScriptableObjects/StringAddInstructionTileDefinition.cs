...
{
    [CreateAssetMenu(menuName = "Mona Brains/Tiles/Strings/StringAdd", fileName = "StringAdd")]
    public class StringAddInstructionTileDefinition : ScriptableObject, IInstructionTileDefinition
    {
        [SerializeReference] protected IInstructionTile _tile = new StringAddInstructionTile();
