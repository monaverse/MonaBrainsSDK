...
{
    [Serializable]
    public class BindPositionXInstructionTile : InstructionTile, IActionInstructionTile, IInstructionTileWithPreload
    {
        public const string ID = "BindPositionX";
        public const string NAME = "Bind East / West";
        public const string CATEGORY = "Position Bounds";
        public override Type TileType => typeof(BindPositionXInstructionTile);
        ...
        public BindPositionXInstructionTile() { }

        public void Preload(IMonaBrain brain) => _brain = brain;

        public override InstructionTileResult Do()
        {
            _brain.Body.PositionBounds.x.Bind(_min, _max);
