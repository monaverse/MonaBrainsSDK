...
{
    [Serializable]
    public class OnNumberOddInstructionTile : InstructionTile, IInstructionTileWithPreload, IOnValueChangedInstructionTile, IConditionInstructionTile, IStartableInstructionTile
    {
        public const string ID = "OnNumberOdd";
        public const string NAME = "Value Is Odd";
        public const string CATEGORY = "Values";
        public override Type TileType => typeof(OnNumberOddInstructionTile);
        ...
        public OnNumberOddInstructionTile() { }
