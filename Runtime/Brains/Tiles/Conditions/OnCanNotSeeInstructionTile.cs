...
{
    [Serializable]
    public class OnCanNotSeeInstructionTile : InstructionTile, ITriggerInstructionTile, IOnNearInstructionTile, IDisposable, IConditionInstructionTile, IOnStartInstructionTile, IStartableInstructionTile
    {
